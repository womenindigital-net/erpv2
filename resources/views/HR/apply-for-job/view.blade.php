            ...
            <div class="card-body p-0 apply-view-only">
                ...
                <div class="tab-content p-3 text-muted">
                    <div class="tab-pane active" id="case-histroy" role="tabpanel">
                            <form action="{{ route('apply.show', $record->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    ...
                                    <div class="col-6 d-flex mb-3">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <img src="public/images/{{$record->cv_upload}}" height="30px" width="30px" /> 
                                        </div>
                                    </div>
                                    <div class="col-6 d-flex  mb-3">
                                        <label for="example-text-input" class="col-md-4">Is company employee:</label>
                                        <div class="square-switch">
                                            <input name="is_company_employee" type="checkbox"  switch="bool"
