                ...
                <div class="card-body p-0">
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="certificate" role="tabpanel">
                            <form action="{{ route('certificate.update', $record->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                {{-- <div class="col-12 d-flex mb-3">
                                    ...
                                    <div class="square-switch">
                                        <input name="type" type="checkbox" id="square-switch10" switch="bool"
                                            @if($record->type) {{ 'checked' }} @else  @endif />
                                        <label for="square-switch10" data-on-label="Academic" data-off-label="Training"></label>
                                    </div>
                                </div> --}}
                                <div class="col-12 d-flex mb-3">
