                ...
                <div class="card-body">
                    ...
                    <div class="tab-content p-3 text-muted">
                        <div class="tab-pane active" id="home" role="tabpanel">
                            <form action="{{ route('leave-type.update', $record->id) }}" method="PUT">
                                @csrf
                                @method('PUT')
                                <div class="modal-body apply-view-only">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->name }}" name="name" placeholder="Enter Name here"></x-input-text>
                                            </div>
                                        </div>
                                        <div class="col-md-8">
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <x-input-textarea value="{{ $record->description }}" name="description" placeholder=""></x-input-textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            :checked="$record->calculation_type"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->calculation_interval }}" name="calculation_interval" type="number"
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <x-input-radio-or-check
                                                    :checked="$record->calculation_base"
                                                    name="calculation_base" label="Calculation Base"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    <x-input-radio-or-check
                                                    :checked="$record->measurement_unit"
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <x-input-text
                                                    value="{{ $record->leave_ttl }}"
                                                    name="leave_ttl" type="number"
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-4">
                                                    ...
                                                    <x-input-text
                                                        value="{{ $record->max_carry_cash_day }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="mb-3">
                                                    <x-input-radio-or-check
                                                    :checked="$record->leave_nature"
                                                    name="leave_nature" label="Leave Nature"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="square-switch">
                                                        <input name="is_active" type="checkbox" id="square-switch10"
                                                            switch="bool"@if($record->is_active)
                                                            checked
                                                            @endif/>
