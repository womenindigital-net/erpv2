                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->policy_name }}" name="policy_name" placeholder="Enter Policy Name Here">
                                                </x-input-text>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->over_time_start_grace }}" name="over_time_start_grace"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->lunch_break }}"  name="lunch_break" placeholder="Lunch Break in minute">
                                                </x-input-text>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->lunch_time }}" name="lunch_time" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->working_hour }}" name="working_hour" placeholder="Enter working hour">
                                                </x-input-text>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <div class="input-group" id="timepicker-input-group3">
                                                        <x-input-text value="{{ $record->sun_in }}" name="sun_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->sun_out }}" name="sun_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="sun_is_next_day" id="square-switch3"
                                                        switch="bool" @if($record->sun_is_next_day) checked @else  @endif />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <div class="input-group" id="timepicker-input-group3">
                                                        <x-input-text value="{{ $record->mon_in }}" name="mon_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text  value="{{ $record->mon_out }}" name="mon_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="mon_is_next_day" id="square-switch4"
                                                        switch="bool" @if($record->mon_is_next_day) checked @else  @endif  />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <div class="input-group" id="timepicker-input-group3">
                                                        <x-input-text value="{{ $record->thu_in }}" name="thu_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->thu_out }}" name="thu_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="thu_is_next_day" id="square-switch5"
                                                        switch="bool" @if($record->thu_is_next_day) checked @else  @endif  />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <div class="input-group" id="timepicker-input-group3">
                                                        <x-input-text value="{{ $record->wed_in }}" name="wed_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->wed_out }}" name="wed_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="wed_is_next_day" id="square-switch6"
                                                        switch="bool" @if($record->wed_is_next_day) checked @else  @endif  />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    <label class="form-label">Thu In</label>
                                                    <div class="input-group" id="timepicker-input-group3">
                                                        <x-input-text value="{{ $record->th_in }}" name="th_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Thu Out</label>
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->th_out }}" name="th_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="th_is_next_day" id="square-switch9"
                                                        switch="bool"  @if($record->th_is_next_day) checked @else  @endif/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <div  class="input-group" id="timepicker-input-group3">
                                                        <x-input-text  value="{{ $record->fri_in }}" name="fri_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->fri_out }}" name="fri_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="fri_is_next_day" id="square-switch11"
                                                        switch="bool" @if($record->fri_is_next_day) checked @else  @endif />
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                <div>
                                                    ...
                                                    <div class="input-group" id="timepicker-input-group3">
                                                        <x-input-text value="{{ $record->sat_in }}" name="sat_in" type="time"></x-input-text>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group" id="timepicker-input-group3">
                                                    <x-input-text value="{{ $record->sat_out }}" name="sat_out" type="time"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox" name="sat_is_next_day" id="square-switch12"
                                                        switch="bool" @if($record->sat_is_next_day) checked @else  @endif />
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="square-switch">
                                                    <input type="checkbox"  name="deduct_Leave_for" id="square-switch10"
                                                        switch="bool" @if($record->deduct_Leave_for) checked @else  @endif />
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <x-input-text value="{{ $record->deduct_in_minute }}" name="deduct_in_minute" type="number"
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <x-input-textarea value="{{ $record->policy_desc }}" name="policy_desc"></x-input-textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
