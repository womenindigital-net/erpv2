      ...
      <div class="card-body">
        ...
        <div class="tab-content p-3 text-muted">
          <div class="tab-pane active" id="home" role="tabpanel">
            <form action="{{ route('supplier-type.update', $record->id) }}" method="post">
              @csrf
              @method('PUT')
              <div class="row">
                <div class=" col-6">
                  <div class="row ">
                    ...
                    <div class="col-7 mt-3 mb-3">
                      <x-input-text value="{{ $record->name }}" name="name" placeholder="Supplier type name here">
                      </x-input-text>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-7 mt-3 mb-3">
                      <x-input-textarea value="{{ $record->description }}" name="description"
                        placeholder="Enter description here"></x-input-textarea>
                    </div>
                  </div>
