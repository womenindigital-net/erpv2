                            ...
                            <div class="modal-body">
                                <div class="col-12 d-flex  mb-3">
                                    <label for="example-text-input" class="col-md-2 col-form-label  pe-2">Package
                                        Name:</label>
                                    <div class="col-md-8">
                                        <x-input-text value="{{$record->package_name}}" name="package_name" type="text"
                                            placeholder="">
                                        </x-input-text>
                                    </div>
                                </div>
                                <div class="col-12 d-flex mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <x-input-text value="{{ $record->description }}" name="description" type="text"
                                            placeholder="">
                                        </x-input-text>
                                    </div>
                                </div>
                                <div class="col-12 d-flex mb-3">
                                    ...
                                    <div class="col-md-8">
                                        <x-input-text value="{{ $record->amount}}" name="amount" type="number"
                                            placeholder="">
                                        </x-input-text>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 d-flex  mb-3">
                                    <label for="example-text-input" class="col-md-2 col-form-label  pe-2">Sal Head
                                        Id:</label>
                                    <div class="col-md-8">
                                        <x-input-select :selected="$record->sal_head" name="sal_head"
                                            :records="$salHeadId" />
                                    </div>
                                </div>
                                <div class="col-12 d-flex mb-3">
                                    <label for="example-text-input" class="col-md-2 col-form-label  pe-2">Total Amount
                                        ...
                                        Year:</label>
                                    <div class="col-md-8">
                                        <x-input-text name="total_amount" value="{{ $record->total_amount }}"
                                ...
                                <div class="col-12 d-flex mb-3">
                                    <label for="example-text-input" class="col-md-2 col-form-label  pe-2">Curnc
                                        Id:</label>
                                    <div class="col-md-8">
                                        <x-input-select :selected="$record->curnc_id" name="curnc_id"
                                            :records="$curncId" />
                                    </div>
                                </div>
