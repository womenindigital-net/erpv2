                                                    ...
                                                    <div class="row border border-info my-3">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="mb-2 row mt-5">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <x-input-text name="email" value="{{ $record->email }}" type="email"
                                                    ...
                                                    <div class="row border border-info my-3">
                                                        <div class="col-6">
                                                            <div class="mb-2 row mt-5">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <x-input-text name="address_1" value="{{ $record->address_1 }}" placeholder="Address 1">
                                                                    </x-input-text>
                                                                </div>
                                                            </div>
                                                            <div class="mb-2 row">
                                                        ...
                                                        <div class="row my-2 border border-info ">
                                                            <div class="col-md-3 mt-4">
                                                                <h5 class="mb-5">Is Card Allow:
                                                                    ...
                                                                    name="is_card_allow" value="{{ $record->is_card_allow }}" checked>
                                                                </h5>
                                                            </div>
                                                            <label for="example-search-input"
                                                            ...
                                                            <div class="col-md-3 mt-1 mt-4">
                                                                <h5 class="mb-5">Is Active:
                                                                    <input class="form-check-input ms-2" type="checkbox"
                                                                        name="is_active" value="{{ $record->is_active }}" checked>
                                                                </h5>
                                                            </div>
                                                        </div>
                                                </div>
