                            ...
                            <div class="card p-0 m-0">
                                <div class="card-body">
                                    <form id="builditp" method="post" enctype="application/x-www-form-urlencoded"
                                        action="{{route('assign-task.store')}}">
                                        @csrf
                                        <div class="row pb-3">
                                            <div class="col-6 d-flex">
                                                <label class="col-4 col-form-label"> Student Name</label>
                                                <div class="col-6">
                                                    <x-input-select name="student_id" :records="$students" :required='true'/>
                                                </div>
                                            </div>
                                            <div class="col-6 d-flex">
                                                <label for="example-text-input" class="col-md-4 col-form-label">Assignment
                                                    Name</label>
                                                <div class="col-md-6">
                                                    <x-input-text name="assignment_name" placeholder="ITP Name"></x-input-text>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row pb-3">
