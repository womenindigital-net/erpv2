            ...
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-12">
                        ...
                        <img id="head" src="{{ asset('assets/images/header.png') }}" style="width: 100%; display: none;"
                            alt="">
                            ...
                            <div id="wizard-navigation">
                                <ul class="wizard-navigation">
                                    ...
                                    <li class="w-100"><a href="#referralInformation" data-toggle="tab">রেফারাল
                                            তথ্য</a></li>
                                    <li class="w-100"><a href="#TheTrendOfEvolution" data-toggle="tab">ক্রমউন্নয়নের
                                            ধারা</a></li>
                                    <li class="w-100"><a href="#HistoryOfDevelopment" data-toggle="tab">উন্নয়নের
                                            ইতিহাস</a></li>
                                    ...
                                    <li class="w-100"><a href="#LearningSkills" data-toggle="tab">শেখার
                                            দক্ষতা</a></li>
                                    <li class="w-100"><a href="#Self-reliance" data-toggle="tab">স্বনির্ভরতা</a>
                                    </li>
                        ...
                        <div class="col-sm-9 col-md-9">
                            <form action="{{ route('case-history.store', $caseHistory->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="tab-content apply-view-only">
                                    ...
                                    <div class="tab-pane" id="referralInformation">
                                        <section>
                                            ...
                                            <x-input-radio-or-check :checked="$caseHistory->has_move_ability"
                                                name="has_move_ability"
                                            ...
                                            <!-- end row -->
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->has_fine_equipment_use_ability"
                                                name="has_fine_equipment_use_ability"
                                                label="সূক্ষ্ম যন্ত্রপাতি ব্যবহার করা সহ ফাইন মটরের দক্ষতা আছে কি?"
                                                :records="$constants::$yesNo">
                                            </x-input-radio-or-check>
                                            <!-- end row -->
                                            <x-input-radio-or-check :checked="$caseHistory->has_write_ability"
                                                name="has_write_ability" label="লিখার পদ্ধতি ঠিক আছে কিনাঃ?"
                                                :records="$caseConstants::$hasWriteAbilities" type="checkbox"
                                            ...
                                            <!-- end row -->
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->has_abil_to_comminite_socilely"
                                            ...
                                            <x-input-radio-or-check :checked="$caseHistory->has_any_learning_obstacle"
                                                ...
                                                :records="$caseConstants::$hasAnyLerningAbstagol" type="checkbox"
                                                :isVertical="false" :multiple="true">
                                            </x-input-radio-or-check>
                                            <!-- end row -->
                                            ...
                                            <!-- end row -->
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->is_able_to_use_correct_word_in_sentence"
                                            ...
                                            <!-- end row -->
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->has_past_assessment_by_specialist"
                                            ...
                                            <!-- end row -->
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->has_family_learning_disability"
                                                name="has_family_learning_disability"
                                                label="লার্নিং ডিজাবিলিটি বা কোন কিছু শিখতে পারাতে কোন সমস্যা পরিবারে কারো ছিল কিনা?"
                                                :records="$constants::$yesNo">
                                            </x-input-radio-or-check>
                                            <!-- end row -->
                                            <x-input-radio-or-check :checked="$caseHistory->has_instability"
                                                name="has_instability" label="সন্তানের মধ্যে অস্থিরতা আছে কিনা"
                                                :records="$constants::$yesNo">
                                            </x-input-radio-or-check>
                                        </section>
                                    </div>
                                    ...
                                    <div class="tab-pane" id="HistoryOfDevelopment">
                                        <section>
                                            <div>
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->is_able_to_eat_hard_thing"
                                                    name='is_able_to_eat_hard_thing' label="শক্ত খাবার খেতে পারে কিনা?"
                                                    :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->is_able_to_control_breathing"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_swallow_food_at_once"
                                                    name='does_swallow_food_at_once'
                                                    label="খাবার একবারে গিলে ফেলে কিনা?" :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_take_longer_time_while_eating"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->is_any_problem_in_chewing_food"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check :checked="$caseHistory->sat_alone_in"
                                                    name='sat_alone_in' label="কোন বয়সে একা একা বসতে শিখেছে?"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->learned_to_walk_alone_in"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->dose_have_balancing_problem"
                                        ...
                                        <section>
                                            <div>
                                                ...
                                                <x-input-radio-or-check :checked="$caseHistory->first_voice_lang"
                                                    name='first_voice_lang' label="শিশুর কথা বলার প্রথম ভাষা কোনটি?"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->in_which_age_spoke_the_first_word"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->is_able_spake_simple_sentence"
                                                    name='is_able_spake_simple_sentence' label="সহজ বাক্য বলতে পারে কি?"
                                                    :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->how_many_word_use_in_a_sentence_max"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->can_you_speak_any_other_language"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->dose_spake_in_other_lang"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->from_which_year_learning_other_lang"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->from_where_learn_other_lang"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_he_response_if_call_by_his_name"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->dose_use_wrong_word_while_speaking"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->in_which_sound_child_react"
                                                ...
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_follow_verbal_commend"
                                                    name='does_follow_verbal_commend' label="মৌখিক নির্দেশ মেনে চলে"
                                                    :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->is_able_to_use_right_word_for_right_sentence"
                                    ...
                                    <div class="tab-pane" id="WorkingSkills">
                                        <section>
                                            <div>
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->in_which_age_got_toilet_training"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_go_to_toilet_himself"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_go_to_toilet_in_unknown_place"
                                                    name='does_go_to_toilet_in_unknown_place'
                                                    label="অপরিচত জায়গায় টয়লেটে যায়?" :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_like_drawing_and_writing_in_home"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->do_you_things_obey_elder_elder_is_heard"
                                                ...
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->can_clean_himself_after_properly"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->can_wear_cloth_himself_after_properly"
                                    ...
                                    <div class="tab-pane" id="SocialSkills">
                                        <section>
                                            <div>
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_friend_come_to_play_in_home"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_careless_for_others"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->are_you_tense_for_specific_behaviour"
                                        ...
                                        <section>
                                            <div>
                                                ...
                                                <div class="row border-top py-2">
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->is_curious_to_learn_new_things"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->can_understand_simple_things_right_way"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->can_learn_word_spelling"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->how_long_child_can_remember_after_teaching"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->is_home_work_a_simple_things"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->does_change_behaviour_during_homework"
                                                    ...
                                                    <!-- end row -->
                                                    <x-input-radio-or-check
                                                        :checked="$caseHistory->does_feel_messy_about_paper_and_books"
                                    ...
                                    <div class="tab-pane" id="Self-reliance">
                                        <section>
                                            <div>
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_irrelevant_work_during_meal"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_scream_during_wearing_cloth"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->how_you_will_describe_you_child"
                                                ...
                                                <x-input-radio-or-check :checked="$caseHistory->bath" name='bath'
                                                    ...
                                                    secondaryInputLabel="বিস্তারিত লিখুন" :isVertical="false"
                                                    :multiple="true"
                                                    :secondaryInputValue="$caseHistory->bath_secondary">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check :checked="$caseHistory->necessary_things"
                                                    name='necessary_things' label="প্রয়োজনীয় জিনিস" type="checkbox"
                                                    :records="$caseConstants::$necessaryThings"
                                                    secondaryInputLabel="বিস্তারিত লিখুন"
                                                    :secondaryInputValue="$caseHistory->necessary_things_secondary"
                                                    :isVertical="false" :multiple="true">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_have_the_navigation_capability"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check :checked="$caseHistory->mobility"
                                                    name='mobility' label="মবিলিটি" type="checkbox"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_accept_routing_change"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_get_disappointed_quickly"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->can_stay_longer_if_needed"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_have_tremendous_behaviors_at_home"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->seems_like_not_interested_in_playing"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check :checked="$caseHistory->response"
                                                    name='response' label="সারা প্রদান"
                                                    :records="$caseConstants::$answerTheCall">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check :checked="$caseHistory->day_dreamer"
                                                    name='day_dreamer'
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check :checked="$caseHistory->does_move"
                                                    name='does_move' label="ঘোরাঘুরি করে" :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_like_to_sit_straight"
                                                    name='does_like_to_sit_straight' label="সোজা হয়ে বসতে পছন্দ করে কি?"
                                                    :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->is_expert_play_with_ball"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->does_ignore_playing_with_ball"
                                                ...
                                                <x-input-radio-or-check :checked="$caseHistory->does_run_in_wrong_way"
                                                    name='does_run_in_wrong_way' label="বেমানান ভঙ্গিতে দৌঁড়ায়"
                                                    :records="$constants::$yesNo">
                                                </x-input-radio-or-check>
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                ...
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->staying_in_motion_all_the_time"
                                                ...
                                                <!-- end row -->
                                                <x-input-radio-or-check
                                                    :checked="$caseHistory->which_kind_of_task_he_try_to_skip"
                                    ...
                                    <div class="tab-pane" id="Matters">
                                        <section>
                                            ...
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->how_would_you_describe_the_child"
                                    ...
                                    <div class="tab-pane" id="report">
                                        <section>
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->whether_the_eyes_were_examined"
                                            ...
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->hearing_attach_report_if_checked"
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <div class="input-group" id="datepicker2">
                                                        <x-input-text
                                                            ...
                                                            type="file" name='hearing_attach_report_if_checked'>
                                                        </x-input-text>
                                                    </div>
                                                    <!-- input-->
                                                </div>
                                            ...
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->whether_the_child_received_any_head_injuries"
                                            ...
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->the_baby_had_an_ear_infection_or_a_problem"
                                            ...
                                            <x-input-radio-or-check
                                                :checked="$caseHistory->no_illness_or_hospitalization_was_required"
                ...
                <img id="footer" src="{{ asset('assets/images/footer.png') }}" style="width: 100%; display: none;"
                    alt="">
