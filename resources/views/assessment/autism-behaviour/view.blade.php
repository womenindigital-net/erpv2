                        ...
                        <div class="wizard-container">
                            <div class="card_stap wizard-card row" data-color="red" id="wizard">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="SensoryBehaviors">
                                                <section>
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->sometimes_shows_no_startle_response" name="sometimes_shows_no_startle_response"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->covers_ears_at_many_sounds" name="covers_ears_at_many_sounds"
                                                        label="Covers ears at many sounds"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->squints_frowns_covers_eyes_when_in_the_presence_of_natural_light"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->frequently_has_no_visual_reaction" name="frequently_has_no_visual_reaction"
                                            ...
                                            <div class="tab-pane" id="RelatingBehaviors">
                                                <section>
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->does_not_reach_out_when_reached_for" label="Does not reach out when reached for "
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->not_responsive_to_other_peoples_facial_expressions_or_feelings"
                                                        label="Not responsive to other people’s facial expressions/feelings"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->actively_avoids_eye_contact" label="Actively avoids eye contact"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->resists_being_touched_or_held" label="Resists being touched or held"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->is_flaccid_when_held_in_arms" label="Is flaccid when held in arms"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->is_stiff_and_hard_to_held" label="Is stiff and hard to held"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->has_not_developed_any_friendships" label="Has not developed any friendships"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->often_frightened_or_very_anxious" label="Often frightened or very anxious "
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- end row -->
                                            ...
                                            <div class="tab-pane" id="BodyandObjectUseBehaviors">
                                                <section>
                                                    <x-input-radio-or-check :checked="$record->whirls_self_for_long_periods_time" name="whirls_self_for_long_periods_time"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->insists_on_keeping_certain_objects" name="insists_on_keeping_certain_objects"
                                                        label="Insists on keeping certain objects with him/ her"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->rocks_self_for_long_periods_time" name="rocks_self_for_long_periods_time"
                                                        label="Rocks self for long periods of time"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->does_lot_lunging_and_darting" name="does_lot_lunging_and_darting"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->walks_on_toes" name="walks_on_toes" label="Walks on toes"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->hurts_self_banging_head" name="hurts_self_banging_head"
                                                        label="Hurts self by banging head, biting hand, etc…"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->twirls_spins_bangs_objects_lot" name="twirls_spins_bangs_objects_lot"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->gets_involved_complicated" name="gets_involved_complicated"
                                            ...
                                            <div class="tab-pane" id="LanguageBehaviors">
                                                <section>
                                                    ...
                                                    <x-input-radio-or-check :checked="$record->has_pronoun_reversal" name="has_pronoun_reversal"
                                                        label="Has pronoun reversal"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->atonalspeech_pattern" name="atonalspeech_pattern"
                                                        label="Atonal Speech pattern"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->does_not_respond_to_own_name_when_called_out_among_two_others"
                                                    ...
                                                    <x-input-radio-or-check :checked="$record->seldom_says_yes_or_I" name="seldom_says_yes_or_I"
                                                        label="Seldom says “yes” or “I”"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->does_not_follow_simple_commands_involving_prepositions"
                                                        name="does_not_follow_simple_commands_involving_prepositions"
                                                        label="Does not follow simple commands involving prepositions"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->gets_desired_objects_by_gesturing" name="gets_desired_objects_by_gesturing"
                                                        label="Gets desired objects by gesturing"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->repeats_phrases_over_and_over" name="repeats_phrases_over_and_over"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->uses_5_spontaneous_words_per_day" name="uses_5_spontaneous_words_per_day"
                                                        label="Uses 0-5 spontaneous words per day to communicate wants and needs"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->repeats_sounds_or_words" name="repeats_sounds_or_words"
                                                        label="Repeats sounds or words"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->echoes_questions_or_statements" name="echoes_questions_or_statements"
                                                        label="Echoes questions or statements made by others"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->uses_at_least_15_but_less_than_30" name="uses_at_least_15_but_less_than_30"
                                ...
                                retardation" :records="$constants::$autismBehaviorCheck">
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->severe_temper_tantrums" name="severe_temper_tantrums"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->does_not_wait_for_needs_to_be_met" name="does_not_wait_for_needs_to_be_met"
                                                        label="Does not wait for needs to be met"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->difficulties_with_toileting" name="difficulties_with_toileting"
                                                        label="Difficulties with toileting"
                                                        :records="$constants::$autismBehaviorCheck">
                                                    </x-input-radio-or-check>
                                                    <!-- row end -->
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->frequently_unaware_surroundings" name="frequently_unaware_surroundings"
                                                    ...
                                                    <!-- row end -->
                                                    <x-input-radio-or-check :checked="$record->a_developmental_delay_was_identified" name="a_developmental_delay_was_identified"
