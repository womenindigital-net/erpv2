                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="General">
                                            <section>
                                                ...
                                                <x-input-radio-or-check label="Communication" :checked="$general->communication ?? ''"
                                                    name="communication" :records="$constants::$yesNoEn">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
                                                <x-input-radio-or-check label="Communication" :checked="$general->communication_one ?? ''"
                                                    name="communication_one" :records="$therapyConstants::$communication">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
                                            </section>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="Transitional_movement">
                                            <section>
                                                <x-input-radio-or-check :checked="$transitional_movements->rolling_supine_to_prone_one ?? ''" label="Rolling supine to prone"
                                                    name="rolling_supine_to_prone_one" :records="$constants::$yesNoEn">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
                                                ...
                                                <!-- row end -->
                                                {{-- <x-input-radio-or-check :checked="$transitional_movements->rolling_supine_to_prone ??
                                        ...
                                        <div class="tab-pane" id="Fine_motor_skil">
                                            <section>
                                                ...
                                                {{-- <x-input-radio-or-check :checked="$fine_motor_skill->grasp_type ?? ''"
                                                label="Grasp type" :records="$constants::$yesNoEn">
                                            </x-input-radio-or-check> --}}
                                                <!-- row end -->
                                        ...
                                        <div class="tab-pane" id="Sensory_Skill">
                                            <section>
                                                ...
                                                {{-- <x-input-radio-or-check :checked="$sensory_skill->vestibular ?? ''"
                                        ...
                                        <div class="tab-pane" id="Visual_Perception">
                                            <section>
                                                ...
                                                <x-input-radio-or-check label="Visual Spatial" :checked="$visual_perception->visual_spatial ?? ''"
                                                    name="visual_spatial" :records="$constants::$yesNoEn">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
                                        ...
                                        <div class="tab-pane" id="Activities_of_Daily_living">
                                            <section>
                                                ...
                                                <x-input-radio-or-check label="Does the child attend school?"
                                                    name="attend_school" :checked="$activities_of_daily_living->attend_school ?? ''" :records="$constants::$yesNoEn">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
                                        ...
                                        <div class="tab-pane" id="Strength">
                                            <section>
                                                <x-input-radio-or-check :checked="$strength->physical ?? ''" name="physical"
                                                    label="Physical (Gross motor/Fine motor)" :records="$constants::$yesNoEn">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
                                                ...
                                                <x-input-radio-or-check :checked="$strength->strength_communication ?? ''" label="Communication"
                                                    Name="strength_communication" :records="$constants::$yesNoEn">
                                                </x-input-radio-or-check>
                                                <!-- row end -->
