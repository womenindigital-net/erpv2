                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane" id="Signs_Of_Tactile_Dysfunction">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check name="cothered_by_rough_bed_sheets"
                                                                    :checked="$signs_of_tactile_dysfunction->cothered_by_rough_bed_sheets ?? ''"
                                                        ...
                                                        <div class="tab-pane" id="Hyposensitivity_To_Touch">
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check name="thoroughly_enjoys_and_seeks"
                                                                    :checked="$hyposensitivity_to_touch->thoroughly_enjoys_and_seeks ?? ''"
                                                                    label="Thoroughly enjoys and seeks out messy play"
                                                                    :records="$constants::$Ind_a_3">
                                                                </x-input-radio-or-check>
                                                                <!-- end row -->
                                                                <x-input-radio-or-check name="craves_vibrating "
                                                                    :checked="$hyposensitivity_to_touch->craves_vibrating ?? ''"
                                                                ...
                                                                <x-input-radio-or-check name="has_a_preference"
                                                                    :checked="$hyposensitivity_to_touch->has_a_preference ?? ''"
                                                        ...
                                                        <div class="tab-pane"
                                                            ...
                                                            <section>
                                                                ...
                                                                <x-input-radio-or-check label="Maybe afraid of the dark"
                                                                    :checked="$poor_tactile_perception_and_discrimination->maybe_afraid_ofthe_dark ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$poor_tactile_perception_and_discrimination->does_not_notice ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$poor_tactile_perception_and_discrimination->one_pant_leg_is_up_and ?? ''"
                                                        ...
                                                        <div class="tab-pane" id="Signs_Of_Vestibular_Dysfunction">
                                                            <section>
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check name="loses_balance"
                                                                    :checked="$signs_of_vestibular_dysfunction->loses_balance ?? ''"
                                                        ...
                                                        <div class="tab-pane" id="Signs_Of_Vestibular_Dysfunction_under">
                                                            <section>
                                                                <x-input-radio-or-check name="in_constant_motion"
                                                                    :checked="$signs_of_vestibular_dysfunction_under->in_constant_motion ?? ''"
                                                                ...
                                                                <x-input-radio-or-check name="loves_being_tossed_"
                                                                    :checked="$signs_of_vestibular_dysfunction_under->loves_being_tossed_ ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$signs_of_vestibular_dysfunction_under->hypersensitivity_to_touch ?? ''"
                                                        ...
                                                        <div class="tab-pane"
                                                            ...
                                                            <section>
                                                                <x-input-radio-or-check
                                                                    :checked="$signs_of_vestibular_dysfunction_behaviors->hypersensitivity_to_touch ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$signs_of_vestibular_dysfunction_behaviors->loves_seeks ?? ''"
                                                                ...
                                                                <!-- end row -->
                                                                <x-input-radio-or-check
                                                                    :checked="$signs_of_vestibular_dysfunction_behaviors->loves_roughhousing ?? ''"
