                                            ...
                                            <div class="card-body">
                                                <form>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="mb-3">
                                                                <label for="formrow-inputZip" class="form-label ">Assignment Name</label>
                                                                <input type="text" class="form-control" id="formrow-inputZip" placeholder="Enter Your Assignment">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
