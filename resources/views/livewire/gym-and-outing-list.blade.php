            ...
            <table class="table table-bordered w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $record->student->name ?? "name not found" }}</td>
                        <td>{{ $record->teacher->name }}</td>
                        <td>{{ $record->created_at }}</td>
                        <td>
                            <a href="{{ route('gym-and-outing.show', $record->id) }}" target="_blank"
                            ...
                            <a href="{{ route('gym-and-outing.edit', $record->id) }}" target="_blank"
                                rel="noopener noreferrer"
