...
@section('content')
    ...
    @component('components.breadcrumb')
        ...
        @slot('title')  ONLINE HOMEWORKS @endslot
    @endcomponent
    {{-- code  --}}
                                            ...
                                            <div class="card-body">
                                                <div class="row pb-3">
                                                    <div class="col-6 row">
                                                        ...
                                                        <label class="col-4 col-form-label">Home Category</label>
                                                        <div class="col-8">
                                                    ...
                                                    <div data-repeater-list="group-a">
                                                        <div data-repeater-item class="row">
                                                            <div class="row mb-4 col-6">
                                                                <label  class="col-4 col-form-label">Homework Name:</label>
                                                                <div class="col-8">
